...
- NOTICE 2!: I have been working on the app, now I have been migrating it to MVP and MVVM patterns, making unit test and so on improvements, so it will take a little bit more (one or two months) to release it.
