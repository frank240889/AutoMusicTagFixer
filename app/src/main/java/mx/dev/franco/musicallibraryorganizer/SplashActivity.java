...
public class SplashActivity extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        SelectedOptions.MANUAL_CHANGE_FILE = preferences.getBoolean("title_manual_change_switch", false);
        SelectedOptions.AUTOMATICALLY_REPLACE_STRANGE_CHARACTERS = preferences.getBoolean("title_automatically_replace_strange_chars",false);
        SelectedOptions.ALL_SELECTED = preferences.getBoolean("allSelected",false);
        SelectedOptions.SHOW_SEPARATORS = preferences.getBoolean("show_separators",false);

        //Retrieve the string value saved in shared preferences first
        String imageSizeSaved = preferences.getString("size_album_art","-1");
