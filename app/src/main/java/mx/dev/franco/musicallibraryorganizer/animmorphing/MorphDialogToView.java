...
package mx.dev.franco.musicallibraryorganizer.animmorphing;
...
public class MorphDialogToView extends ChangeBounds {
    ...
    public void captureStartValues(TransitionValues transitionValues) {
        ...
        transitionValues.values.put(PROPERTY_COLOR, ContextCompat.getColor(view.getContext(), R.color.md_white_1000));
    ...
    public void captureEndValues(TransitionValues transitionValues) {
        ...
        transitionValues.values.put(PROPERTY_COLOR, ContextCompat.getColor(view.getContext(), R.color.md_statusbar_translucent));
