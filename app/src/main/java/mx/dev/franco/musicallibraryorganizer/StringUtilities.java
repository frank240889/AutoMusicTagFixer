...
public final class StringUtilities {
     ...
     */
    static String sanitizeString(String dirtyString) {
     ...
     */
    static boolean hasNotAllowedCharacters(EditText editText){
     ...
     */
    static String trimString(EditText editText){
     ...
     */
    static boolean isTooLong(EditText editText){
